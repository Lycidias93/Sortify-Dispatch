...
[[ "$(tr -d '\r\n' < "$ROOT/.webui-core/CORE_VERSION")" == "0.6.6" ]]
...
grep -Fq 'Action failed. Details are shown in Actions.' "$ROOT/.webui-core/module/webroot/observability.js"
! grep -Fq '4.7.1-webui-cleanup-hotfix' "$ROOT/module/bin/sortify-domain"
echo 'webui_action_feedback_surface=PASS'
